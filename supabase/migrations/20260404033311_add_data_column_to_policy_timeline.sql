-- Add data column to store the full JSONB blob at the point of transition
ALTER TABLE ads_v2.policy_timeline ADD COLUMN data jsonb;

-- Update triggers to save NEW.data
...
-- Update bootstrap to save data blob too

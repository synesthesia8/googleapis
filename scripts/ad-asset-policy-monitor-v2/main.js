/**
 * Google Ads Asset Policy Monitor v2 — Raw Data Ingestion
 *
 * Pulls EVERYTHING from Google Ads. Stores raw. No transformation.
 * One table per resource type, JSONB storage, typed PKs only.
 *
 * Setup:
...
var EDGE_FUNCTION_URL = 'https://makglpeikfgyugngywmc.supabase.co/functions/v1/ingest-gads-v2';
...
function main() {
  ...
  Logger.log('v2 sync ' + syncId + ' for CID ' + customerId);
  ...
  Logger.log('v2 sync ' + syncId + ' complete. Total rows: ' + totalRows);
}
